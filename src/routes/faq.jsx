...
const Faq = () => {
  return (
    <div className=' faq'>
      <h2> ITALIAN CRUST FAQS & HELP</h2>
      <h3>What is Contactless Delivery?</h3>
      <p>
        Contactless Delivery means that there will be no direct contact between
        customer and delivery rider. Meal will be placed in a pre-agreed
        location and avoid touching or close face to face contact.
      </p>
      ...
      <p>
        ...
        this entire process contactless, cash-on-delivery in this case will not
        be possible.
      </p>
      ...
      <p>
        ...
        respective restaurant. In case certain menu items are not listed in the
        menu page, that restaurant is not serving those items. In case of
        non-availability of ordered product at a particular restaurant, the
        order will not be fulfilled. The restaurant will inform you of the same
      </p>
      <div className='f'>
        <Footer />
      </div>
